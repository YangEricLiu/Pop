...
using System;
using System.Linq;
using REMCommon = SE.DSP.Foundation.Infrastructure;
...
namespace SE.DSP.Foundation.Service
{
    ...
    public class ServiceProviderService : ServiceBase, IServiceProviderService
    {
        ...
        public ServiceProviderDto CreateServiceProvider(ServiceProviderDto dto)
        {
            ...
            //todo:need implements actions

            //Dictionary<string, string> dict = new Dictionary<string, string>();
            //dict.Add("Name", dto.Name);

            //ActionExcusor.Fire("ServiceProviderService.CreateServiceProvider",
            //    false,
            //    PositionType.Before,
            //    dict);
            ...
            using (var ts = TransactionHelper.CreateSerializable())
            {
                ...
                //UserBL.CreateUserInternal(new UserDto { 
                //    Name = dto.UserName,
                //    Email = dto.Email,
                //    RealName = "ServiceProviderAdmin",
                //    Title = DA.Common.Enumeration.UserTitle.ServiceProviderAdmin,
                //    UserType = 0,
