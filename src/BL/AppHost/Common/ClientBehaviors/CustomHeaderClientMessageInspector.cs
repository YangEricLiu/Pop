...
namespace SE.DSP.Pop.BL.AppHost.Common.ClientBehaviors
{
    /// <summary>
    ...
    public class CustomHeaderClientMessageInspector : IClientMessageInspector
    {
        ...
        {
            ////request id
            MessageHeader<Guid> requestIdHeader = new MessageHeader<Guid>(ServiceContext.RequestId);
            ...
            ////current user
            MessageHeader<User> currentUserHeader = new MessageHeader<User>(ServiceContext.CurrentUser);
