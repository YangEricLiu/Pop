...
namespace SE.DSP.Pop.Web.WebHost.Common.ClientBehaviors
{
    ...
    public class CustomHeaderClientMessageInspector : IClientMessageInspector
    {
        ...
        {
            ////request id
            MessageHeader<Guid> requestIdHeader = new MessageHeader<Guid>(WebContext.RequestId);
            ...
            ////current user
            MessageHeader<User> currentUserHeader = new MessageHeader<User>(WebContext.CurrentUser);
